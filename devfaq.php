...
<div class="body">
	...
	<div class="QABox">
		...
		<br />api.php?type=add&deposit=btc_hash&alias=plainusername&key=password[&redirect=url]<br/>
		To resolve an entry:
		<br />api.php?type=resolve&alias=plainusername[&redirect=url]<br/>
		To delete an entry:
		<br />api.php?type=resolve&alias=plainusername&key=password[&redirect=url]<br/>
	...
	<div class="QABox">
		...
		<br />
		<span class="answer">Not yet, but it will be asap!</span>
	</div>
</div>
<?php 
	include 'footer.php';
